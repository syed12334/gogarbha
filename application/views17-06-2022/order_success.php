            ...
            <table>
            	<tr>
                    <td colspan="2">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-bottom:1px solid #e6e6e6">
                            <tr>
                                <td style="padding:10px; width:115px; height:105px"><img src="<?php echo asset_url()?>images/Gogarbha_Logo_White.svg" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <p> <?php if($msg != "success"){?> Payment has been failed and details are as below..<?php }else { ?>New Order has been placed successfully and details are as below.
...
<?php }?></p>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <p>Please contact us on <?php echo $call?> for any queries during our business hours.</p>
                        <p>
                        <?php 
                        if($msg == "success"){
                        $days = $orders[0]->delivery_days;
                        if(intval($days) > 1){
                        ...
                        ?>
                           Your Order will be delivered within <?php echo $days?>.<?php }?> For any other information, log on to <a href="<?php echo base_url()?>">www.gogarbha.com</a>
                        </p>
