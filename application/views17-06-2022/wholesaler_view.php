        ...
        <div class="container">
            <div class="row">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Premium Register</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="account-register" class="container acpage">
        <div class="row">
            <div id="content" class="col-sm-8 col-md-9 col-xs-12 colright">
                <div class="infobg">
                    <h1>Register Premium Account</h1>
					<p>If you already have an account with us, please <a href="<?php echo base_url()?>login" >Sign In</a>.</p>  
					

<?php echo $this->session->userdata('message');?>
                    <form class="form form-horizontal" method="post" enctype="multipart/form-data" onsubmit="wholesaler_register();return false;" action="<?php echo base_url();?>home/wholesaler_register" id="whform">
                        <fieldset id="account">
                           ...
                           <!-- <div class="form-group required">
							...
							<div class="form-group required">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" name="name" id="name" class="form-control" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
                                </div>
                            </div>
							<div class="form-group required">
                                <label class="col-sm-3 col-xs-12 control-label">Company Name</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" name="company_name" id="company_name" class="form-control" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
                                </div>
                            </div>
							<div class="form-group required">
                                <label class="col-sm-3 col-xs-12 control-label">Registered Address</label>
                                <div class="col-sm-9 col-xs-12">
                        ...
                        <fieldset>
							...
							<div class="form-group required">
                                <label class="col-sm-3 col-xs-12 control-label">Company Registration Document</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="file" name="doc" id="doc" class="form-control">
                                </div>
                            </div>
							<div class="form-group required">
                                <label class="col-sm-3 col-xs-12 control-label">PAN number</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" name="pan_no" id="pan_no" class="form-control" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" maxlength="10">
                                </div>
                            </div>
							<div class="form-group required">
                                <label class="col-sm-3 col-xs-12 control-label">GST</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" name="gst" id="gst" class="form-control" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" maxlength="15">
                                </div>
                            </div>
							<div class="form-group required">
                                <label class="col-sm-3 col-xs-12 control-label">Country</label>
                                <div class="col-sm-9 col-xs-12">
                                    <input type="text" name="country" id="country" class="form-control" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
                                </div>
                            </div>
							  <div class="form-group required">
                            ...
                            <div class="buttons">
                                <div class="text-right acspace">
                                   <!-- <input type="submit" onclick="wholesaler_register();" value="Register" class="btn btn-primary">-->
            ...
            <aside id="column-right" class="col-sm-4 col-md-3 col-xs-12 hidden-xs">
                <div class="list-group accolumn">
                    ...
                    <a href="<?php echo base_url()?>login" class="list-group-item">Premium Sign In</a>
