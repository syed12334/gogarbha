...
<span class="myloader" style="display: none"></span>
  ...
  <div class="page-wrapper">
    ...
    <form id="filterform" method="get" action="<?php echo base_url() ?>home/product_detailsview" >
                <ul class="filter_list"> 
                    <li class="filtercheckbox"><label for="100 - 300"><input type="checkbox" name="pricerang[]" class="checkedbox" id='100 - 300' value='100 - 300'/> 100 - 300</label></li>
                    <li class="filtercheckbox"><label for="300 - 500"><input type="checkbox" name="pricerang[]" class="checkedbox" id='300 - 500' value='300 - 500'/> 300 - 500</label></li>
                    <li class="filtercheckbox"><label for="500 - 700"><input type="checkbox" name="pricerang[]" class="checkedbox" id='500 - 700' value='500 - 700'/> 500 - 700</label></li>
                    <li class="filtercheckbox"><label for="700 - 900"><input type="checkbox" name="pricerang[]" class="checkedbox" id='700 - 900' value='700 - 900'/> 700 - 900</label></li>
                    <li class="filtercheckbox"><label for="1000+"><input type="checkbox" name="pricerang[]" class="checkedbox" id='1000+' value='1000'/> 1000+</label></li>
                </ul>
...
//echo "<pre>";print_r($special_offers);exit;
  ...
  <div class="offer-tag"><span><?php  echo round($disc);?>%</span></div>
                            ...
                            <div class="blog-card__content">
                                ...
                                <h6 style="font-size: 13px"><?php echo $p->title; ?></h6>
                                 <p><?= $p->sname?></p>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            $("#sortBy").on('change',function(e) {
                ...
                $.ajax({
                    url :"<?= base_url().'home/sortByListView'; ?>",
                    method :"post",
                    dataType :"html",
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("body").on("click", ".filtercheckbox", function() {
           // e.preventDefault();
         $('.myloader').fadeIn();
            // alert();
            var radbtn = $(this).find('input[type="checkbox"]');
            //alert(radbtn.is(':checked'));
            if (radbtn.is(':checked') == true) {
                radbtn.prop('checked');
            } else {
                radbtn.removeAttr('checked');
            }
            $("#filterform").submit();
        });
