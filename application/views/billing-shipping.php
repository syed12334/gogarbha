...
<html lang="en">
                                ...
                                <div class="card-body row">
									...
									if(is_array($bill)){
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" laceholder="Address Line 1" name="address1" id="address1" value="<?php echo $address1?>" maxlength="200" required/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Address Line 2</label>
                                            <input type="text" class="form-control" placeholder="Address Line 2" name="address2"id="address2" value="<?php echo $address2?>"maxlength="200" />
                                        </div>
                                        <div class="form-group col-md-6" >
                                       ...
                                       <select name="city" id="city" class="form-control" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="">Address Line 1</label>
                                            <input class="form-control" type="text" placeholder="Address Line 1" name="shipaddress1" id="shipaddress1" value="<?php echo $shipaddress1?>" maxlength="200"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Address Line 2</label>
                                            <input class="form-control" type="text" placeholder="Address Line 2" name="shipaddress2" id="shipaddress2" value="<?php echo $shipaddress2?>" maxlength="200"/>
                                        </div>
                                        <div class="form-group col-md-6">
 ...
 <!--                    <tr>
    ...
    <td align="right"><i class="fa fa-rupee-sign" style="margin-right:6px"></i>0</td>
                            ...
                            <tr>
                                <td>Total Amount</td>
                                <td align="right"><i class="fa fa-rupee-sign"></i> <span id="totalamountPaid"><?php echo number_format(floatval($this->cart->total()),2)+floatval($this->session->userdata('taxamountlist'))-number_format(floatval($discountAmount),2)+(int)$this->session->userdata('charges')?></span></td>
                            </tr>
                        </table>
                            <div class="card">
                                <label class="card-body csh-option"> <input type="radio" name="type" id="type" value="razor" /><img src="<?php echo asset_url(); ?>images/icons/easebuzz.png" alt="" style="width:50%;margin-left: 10px"> </label>
		...
		function isvalidpincode(pincode,citys) {
			...
			if (data != '') {
			  ...
			  var totalAmount = '<?php $ars = []; foreach ($this->cart->contents() as $items){
			    								...
			    								echo number_format(floatval(array_sum($ars)),2)+number_format(floatval($this->cart->total()),2)-number_format(floatval($discountAmount),2); ?>';
