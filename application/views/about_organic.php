                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="about-three__content">
                            ...
                            <p><b>Vision</b></p>
                            <p>Increasing the awareness to use and reuse organic produce.</p>

                            <p><b>How we work</b></p>
                            <ol>
                                <li>Connect Logistically, all the organic produces and then take them to the markets.</li>
                                <li>Culminate the produce from across regions &amp; enable a common platform to sell the organic
                                    produce.</li>
                            </ol>

                            <p><b>Farmer Connect</b></p>
                            <ol>
                                <li> Integrating farmers</li>
                                <li>Integrating farm products</li>
                                <li>Taking them to open markets and big retailers.</li>
                            </ol>
                    ...
                    <div class="col-md-6">
                        <img src="<?= asset_url().'images/organic-banner.jpg'?>" class="img-responsive">
                    </div>
