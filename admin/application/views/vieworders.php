            ...
            <table class="table table-bordred" border="0" cellspacing="0" cellpadding="0">
              ...
              ?>
                <tr>
                  ...
                  <td valign="top" align="right"><?php $newAr[] = number_format(floatval($ordp->tax),2) + number_format(floatval($price),2)* number_format(floatval($ordp->qty),2); echo $price_icon; ?> 
                  <?php echo number_format(floatval($ordp->tax),2) + number_format(floatval($price),2)*number_format(floatval($ordp->qty),2); ?></td>
                </tr>
              <?php }
            }else {
              echo "No data found";
